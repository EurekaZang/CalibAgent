...
_go2_apply_param() {
  ...
  case "${key}" in
    ...
    policy_observation_max_linear_acc) _go2_set_default POLICY_OBS_MAX_LINEAR_ACC "${value}" ;;
    policy_observation_max_angular_acc) _go2_set_default POLICY_OBS_MAX_ANGULAR_ACC "${value}" ;;
