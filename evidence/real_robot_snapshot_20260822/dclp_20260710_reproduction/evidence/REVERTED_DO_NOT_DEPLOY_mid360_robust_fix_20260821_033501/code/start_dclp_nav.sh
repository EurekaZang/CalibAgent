...
POLICY_SCAN_MIN_VALID_BEAMS="${POLICY_SCAN_MIN_VALID_BEAMS:-64}"
POLICY_FRONT_SAFETY_ENABLED="${POLICY_FRONT_SAFETY_ENABLED:-true}"
POLICY_FRONT_SAFETY_ANGLE="${POLICY_FRONT_SAFETY_ANGLE:-0.55}"
POLICY_FRONT_SAFETY_BASE_DISTANCE="${POLICY_FRONT_SAFETY_BASE_DISTANCE:-0.55}"
POLICY_FRONT_SAFETY_REACTION_TIME="${POLICY_FRONT_SAFETY_REACTION_TIME:-0.12}"
POLICY_FRONT_SAFETY_DECEL="${POLICY_FRONT_SAFETY_DECEL:-3.0}"
POLICY_FRONT_SAFETY_RELEASE_MARGIN="${POLICY_FRONT_SAFETY_RELEASE_MARGIN:-0.15}"
POLICY_FRONT_SAFETY_HOLD_SEC="${POLICY_FRONT_SAFETY_HOLD_SEC:-0.75}"
POLICY_FRONT_SAFETY_MIN_CLUSTER_BEAMS="${POLICY_FRONT_SAFETY_MIN_CLUSTER_BEAMS:-2}"
POLICY_FRONT_SAFETY_REVERSE_W_LIMIT="${POLICY_FRONT_SAFETY_REVERSE_W_LIMIT:-0.35}"
...
export_all_vars() {
  ...
  export POLICY_SCAN_MIN_VALID_BEAMS POLICY_FRONT_SAFETY_ENABLED POLICY_FRONT_SAFETY_ANGLE
  export POLICY_FRONT_SAFETY_BASE_DISTANCE POLICY_FRONT_SAFETY_REACTION_TIME POLICY_FRONT_SAFETY_DECEL
  export POLICY_FRONT_SAFETY_RELEASE_MARGIN POLICY_FRONT_SAFETY_HOLD_SEC
  export POLICY_FRONT_SAFETY_MIN_CLUSTER_BEAMS POLICY_FRONT_SAFETY_REVERSE_W_LIMIT
...
launch_policy() {
  ...
  export POLICY_SCAN_MIN_VALID_BEAMS="${POLICY_SCAN_MIN_VALID_BEAMS}"
  ...
  export POLICY_FRONT_SAFETY_ENABLED="${POLICY_FRONT_SAFETY_ENABLED}"
  export POLICY_FRONT_SAFETY_ANGLE="${POLICY_FRONT_SAFETY_ANGLE}"
  export POLICY_FRONT_SAFETY_BASE_DISTANCE="${POLICY_FRONT_SAFETY_BASE_DISTANCE}"
  export POLICY_FRONT_SAFETY_REACTION_TIME="${POLICY_FRONT_SAFETY_REACTION_TIME}"
  export POLICY_FRONT_SAFETY_DECEL="${POLICY_FRONT_SAFETY_DECEL}"
  export POLICY_FRONT_SAFETY_RELEASE_MARGIN="${POLICY_FRONT_SAFETY_RELEASE_MARGIN}"
  export POLICY_FRONT_SAFETY_HOLD_SEC="${POLICY_FRONT_SAFETY_HOLD_SEC}"
  export POLICY_FRONT_SAFETY_MIN_CLUSTER_BEAMS="${POLICY_FRONT_SAFETY_MIN_CLUSTER_BEAMS}"
  export POLICY_FRONT_SAFETY_REVERSE_W_LIMIT="${POLICY_FRONT_SAFETY_REVERSE_W_LIMIT}"
