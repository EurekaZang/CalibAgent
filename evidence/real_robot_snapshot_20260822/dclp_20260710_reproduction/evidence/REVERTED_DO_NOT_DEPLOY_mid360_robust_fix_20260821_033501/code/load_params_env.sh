...
_go2_apply_param() {
  ...
  case "${key}" in
    ...
    policy_scan_min_valid_beams) _go2_set_default POLICY_SCAN_MIN_VALID_BEAMS "${value}" ;;
    front_safety_enabled) _go2_set_default POLICY_FRONT_SAFETY_ENABLED "${value}" ;;
    front_safety_angle) _go2_set_default POLICY_FRONT_SAFETY_ANGLE "${value}" ;;
    front_safety_base_distance) _go2_set_default POLICY_FRONT_SAFETY_BASE_DISTANCE "${value}" ;;
    front_safety_reaction_time) _go2_set_default POLICY_FRONT_SAFETY_REACTION_TIME "${value}" ;;
    front_safety_decel) _go2_set_default POLICY_FRONT_SAFETY_DECEL "${value}" ;;
    front_safety_release_margin) _go2_set_default POLICY_FRONT_SAFETY_RELEASE_MARGIN "${value}" ;;
    front_safety_hold_sec) _go2_set_default POLICY_FRONT_SAFETY_HOLD_SEC "${value}" ;;
    front_safety_min_cluster_beams) _go2_set_default POLICY_FRONT_SAFETY_MIN_CLUSTER_BEAMS "${value}" ;;
    front_safety_reverse_w_limit) _go2_set_default POLICY_FRONT_SAFETY_REVERSE_W_LIMIT "${value}" ;;
