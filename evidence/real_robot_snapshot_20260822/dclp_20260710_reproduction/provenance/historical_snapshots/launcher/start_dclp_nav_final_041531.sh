...
launch_policy() {
  ...
  export POLICY_MAX_LINEAR="0.90"; export POLICY_MAX_ANGULAR="0.83776"
  export POLICY_CMD_VEL_V_CAP="1.50"; export POLICY_CMD_VEL_W_CAP="1.5708"
  # Scale policy action magnitude [0, 1] into [min, max] speed ranges.
  export POLICY_CMD_VEL_V_MIN="0.29997"; export POLICY_CMD_VEL_W_MIN="0.27928"
  ...
  export DCLP_LENGTH1="0.504"; export DCLP_LENGTH2="0.504"; export DCLP_WIDTH="0.4464"
...
launch_zmq() {
  ...
  exec python3 "${ROBOT_DIR}/go2_zmq_sport_client.py" \
    ...
    --max-linear 1.50 --max-angular 1.5708 --allow-reverse --sport-timeout 5.0
}
