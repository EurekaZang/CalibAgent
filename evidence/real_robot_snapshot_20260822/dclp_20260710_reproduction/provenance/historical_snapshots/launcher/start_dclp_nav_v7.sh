...
launch_policy() {
  ...
  export POLICY_MAX_LINEAR="2.10"; export POLICY_MAX_ANGULAR="2.19912"
  export POLICY_CMD_VEL_V_CAP="2.10"; export POLICY_CMD_VEL_W_CAP="2.19912"
  # Scale policy action magnitude [0, 1] into [min, max] speed ranges.
  export POLICY_CMD_VEL_V_MIN="0.70"; export POLICY_CMD_VEL_W_MIN="0.73304"
...
launch_zmq() {
  ...
  exec python3 "${ROBOT_DIR}/go2_zmq_sport_client.py" \
    ...
    --max-linear 2.10 --max-angular 2.19912 --allow-reverse --sport-timeout 5.0
}
