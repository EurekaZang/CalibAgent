...
launch_policy() {
  ...
  export POLICY_MAX_LINEAR="1.5"; export POLICY_MAX_ANGULAR="1.5708"
  export POLICY_CMD_VEL_V_CAP="1.5"; export POLICY_CMD_VEL_W_CAP="1.5708"
  export POLICY_CMD_VEL_V_FLOOR="0.5"; export POLICY_CMD_VEL_W_FLOOR="0.5236"
  ...
  export POLICY_STRAIGHTEN_FRONT_GOAL_ANGLE="${POLICY_STRAIGHTEN_FRONT_GOAL_ANGLE:-0.20}"
...
launch_zmq() {
  ...
  exec python3 "${ROBOT_DIR}/go2_zmq_sport_client.py" \
    ...
    --max-linear 1.5 --max-angular 1.5708 --allow-reverse --sport-timeout 5.0
}
