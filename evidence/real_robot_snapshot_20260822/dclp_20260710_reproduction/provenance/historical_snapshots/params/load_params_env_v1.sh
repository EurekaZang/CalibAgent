...
_go2_apply_param() {
  ...
  case "${key}" in
    ...
    cmd_vel_v_floor|policy_cmd_vel_v_floor) _go2_set_default POLICY_CMD_VEL_V_FLOOR "${value}" ;;
    cmd_vel_w_floor|policy_cmd_vel_w_floor) _go2_set_default POLICY_CMD_VEL_W_FLOOR "${value}" ;;
    scan_topic)
